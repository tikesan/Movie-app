            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
              <section class="container mx-auto p-6 font-mono">
                  <div class="w-full flex mb-4 p-2 justify-end">
                      <Link :href="route('admin.tags.create')" class="bg-blue-500 hover:bg-blue-700 text-white px-4 py-2 rounded-lg">Create Tag</Link>
                  </div>
                      ...
                      <div class="w-full overflow-x-auto">
                          <table class="w-full">
                              ...
                              <tbody class="bg-white">
                                      <tr class="text-gray-700" v-for="tag in tags.data" :key="tag.index">
                                          ...
                                          <td class="px-4 py-3 text-sm border space-x-4">
                                              <button
